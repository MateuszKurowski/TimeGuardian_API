...
public class ResourceSelfRequirmentHandler : AuthorizationHandler<ResourceSelfRequirment, Session>
{
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, ResourceSelfRequirment requirement, Session resource)
    {
